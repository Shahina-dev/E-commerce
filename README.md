...
1. Clone the Repository:
   ...
   - If you have Git installed, open a terminal and run the following command:
     ...
     ```
   - Alternatively, you can download the repository as a ZIP file from the following URL: [https://github.com/Shahina-dev/E-Commerce/archive/refs/heads/main.zip](https://Shahina-dev/E-Commerce/archive/refs/heads/main.zip)
